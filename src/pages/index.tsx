...
export default function Home() {
  return (
    <>
      <Head>
        <title>SOLVC</title>
        <meta name="Solana fund raising" content="Crowdlana" />
          ...
          >
            ...
            <div className="hero-content text-center">
              <div className="max-w-md">
                <h1 className="mb-5 text-5xl font-bold" style={{color: "white"}}>SOLVC</h1>
                <p className="mb-5 text-2xl" style={{color: "lightgrey"}}>The Future of Funding on Solana blockchain.</p>
